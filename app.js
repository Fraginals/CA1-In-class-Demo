...
router.get('/', function(req, res){
    ...
    res.render('index');//here is looking for the index template inside the view folder
...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('Timepieces.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('Timepieces.xsl', 'utf8'); //We are reading in the XSL file
